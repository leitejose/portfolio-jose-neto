            ...
            <div className="grid md:grid-cols-2 gap-8">
              {featuredProjects.map((project) => (
                <Link key={project.id} href={`/projects/${project.slug}`}>
                  <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer">
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex flex-col space-y-3">
                        <div className="flex gap-3">
                          {project.demoUrl && (
                            <span className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg text-sm">
                              <ExternalLink className="w-4 h-4 mr-2" />
                              Ver Demo
                            </span>
                          )}
                          {project.repoUrl && (
                            <span className="inline-flex items-center px-4 py-2 bg-gray-800 text-white rounded-lg text-sm">
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {otherProjects.map((project) => (
                <Link key={project.id} href={`/projects/${project.slug}`}>
                  <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 cursor-pointer">
